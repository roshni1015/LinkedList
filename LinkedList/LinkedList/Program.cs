...
while (true)
{
    ...
    switch (option)
    {
        ...
        case 9:
            ...
            break;
        case 10:
            CreatingLinkedList<int> Lvalue9 = new();
            Lvalue9.SortedLinkedList(56);
            Lvalue9.SortedLinkedList(30);
            Lvalue9.SortedLinkedList(40);
            Lvalue9.SortedLinkedList(70);
            Console.Write("Elements in LinkedList are : ");
            Lvalue9.display();
            Console.WriteLine("\n");
            break;
